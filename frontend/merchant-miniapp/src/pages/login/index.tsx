        ...
        <View className="form-section">
          ...
          <View className="agreement-section">
            <Text className="agreement-text">
              登录即表示同意
              <Text className="link" onClick={() => Taro.navigateTo({ url: '/pages/agreement/user/index' })}>
                《用户协议》
              </Text>
              和
              <Text className="link" onClick={() => Taro.navigateTo({ url: '/pages/agreement/privacy/index' })}>
                《隐私政策》
              </Text>
            </Text>
          </View>
