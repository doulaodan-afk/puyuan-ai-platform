...
const pluginMenus: MenuItem[] = [
  {
    ...
    name: '创建设计需求',
    icon: '✨',
    roles: ['boss', 'merchant_owner', 'designer', 'design_assistant', 'operator'],
  },
  {
    path: '/plugins/ai-design-assistant/list',
    name: '我的设计需求',
    icon: '📋',
    roles: ['boss', 'merchant_owner', 'designer', 'design_assistant', 'operator', 'viewer'],
  },
  {
    path: '/plugins/ai-design-assistant/pending',
    name: '设计助理待办',
    icon: '🔔',
    roles: ['boss', 'merchant_owner', 'design_assistant'],
  },
  {
    path: '/plugins/ai-design-assistant/tasks',
    name: '我的任务',
    icon: '✅',
    roles: ['boss', 'merchant_owner', 'designer', 'pattern_maker', 'operator', 'viewer'],
  },
  {
  ...
  },
  {
    ...
    name: '面料库管理',
    icon: '🧵',
    roles: ['boss', 'merchant_owner', 'operator'],
  },
  {
