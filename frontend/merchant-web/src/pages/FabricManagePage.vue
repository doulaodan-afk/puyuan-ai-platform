...
<template>
  <div class="fabric-manage-page page-container">
    ...
    <div class="filters">
      ...
      <button @click="fetchFabrics" class="btn btn-secondary">
        刷新
      </button>
    </div>
    ...
    <div v-else class="fabric-grid">
      <div v-for="fabric in fabrics" :key="fabric.id" class="fabric-card">
        <div class="card-image">
          ...
          <!-- 多图指示 -->
          <div v-if="fabric.images?.length > 1" class="image-count">
        ...
        <div class="card-content">
          ...
          <div v-if="fabric.videoUrl" class="video-indicator">
            🎥 含视频
          </div>
        </div>

        <div class="card-actions">
          <button @click.stop="openEditDialog(fabric)" class="btn btn-secondary">
            编辑
          </button>
          <button @click.stop="removeFabric(fabric.id)" class="btn btn-danger">
            下架
          </button>
        </div>
      </div>
        ...
        <div class="dialog-body">
          ...
          <div class="form-group">
            ...
            <textarea
              ...
              placeholder='{"克重": "20mm", "门幅": "150cm", "成分": "100%真丝"}'
            ></textarea>
          </div>
