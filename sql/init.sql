...
VALUES
  ...
  (2003, 'test_studio_001', '测试工作室', 1, 'basic', 'standard')
...
VALUES
  ...
  (1002, 2001, '13800000002', '面料特供商A', 'merchant_operator', 1),
...
VALUES
  (3001, 'ai_image_gen_v1', 'AI商品图生成', '1.0.0', 'http://plugin-ai-image-svc/api/generate', '/plugins/ai-image', 'token', 20, 1, 'pass'),
  (3002, 'ai_script_gen_v1', 'AI视频脚本生成', '1.0.0', 'http://plugin-ai-script-svc/api/generate', '/plugins/ai-script', 'token', 10, 1, 'pass'),
  (3010, 'ai_image_gen', 'AI商品图生成', '1.0.0', '/api/plugin/invoke/ai_image_gen', '/ai-tools/image-gen', 'token', 10, 1, 'pass'),
  (3011, 'ai_script_gen', 'AI视频脚本生成', '1.0.0', '/api/plugin/invoke/ai_script_gen', '/ai-tools/script-gen', 'token', 10, 1, 'pass'),
  (3012, 'ai_translate', 'AI跨境翻译', '1.0.0', '/api/plugin/invoke/ai_translate', '/ai-tools/translate', 'token', 3, 1, 'pass'),
  (3020, 'ai_design_assistant', 'AI设计助手', '1.0.0', '/api/plugin/invoke/ai_design_assistant', '/design-requirement/create', 'token', 3, 1, 'pass')
ON DUPLICATE KEY UPDATE
...
-- 充值订单（兑换率：1元 = 10 Token）
INSERT INTO recharge_order (order_no, tenant_id, amount, token_grant, pay_channel, pay_status, paid_at)
VALUES
  ('RC20260518001', 2001, 200.00, 2000, 'wechat_pay', 'paid', NOW()),
  ('RC20260518002', 2002, 50.00, 500, 'wechat_pay', 'paid', NOW())
ON DUPLICATE KEY UPDATE
...
VALUES
  (2001, 'BIZ20260518001', 'req_seed_001', 'recharge', 'in', 2000, 200.00, 2500, NULL, 'success', NOW()),
  (2001, 'BIZ20260518002', 'req_seed_002', 'debit', 'out', 20, 2.00, 2480, 'ai_image_gen_v1', 'success', NOW())
ON DUPLICATE KEY UPDATE
...
VALUES
  (2001, CURRENT_DATE(), 2000, 20, 1, 200.00, 0.00),
  (2002, CURRENT_DATE(), 500, 0, 0, 50.00, 0.00)
ON DUPLICATE KEY UPDATE
...
VALUES
  ('req_seed_invoke_001', 2001, 'ai_image_gen_v1', 'openai', 20, 2800, 0, 'low')
ON DUPLICATE KEY UPDATE
...
VALUES
  ...
  ('pricing', 'register_bonus_token', '10', 1, 0, '新用户注册赠送 Token'),
  ('pricing', 'token_ratio', '10', 1, 1, '充值兑换率：1元 = N Token'),
  ('pricing', 'cash_per_token', '0.1', 1, 2, '扣费记账单价：1 Token = N 元')
